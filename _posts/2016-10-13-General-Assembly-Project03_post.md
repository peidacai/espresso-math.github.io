...
This poorly charted histogram for sales per store in 2015 (shown above), was included to demonstrate the extreme skewness of the sales per store data. There were extreme outliers with annual revenue of about \$9 million, contrast this with the majority of the stores raking in only \$2 00,000 in 2015.
