...
H$_a$: Average position of songs which peaked early was not better than average position of songs which peaked later.

$$H_o: $\mu_{peaked-late} - $\mu_{peaked-early} > 0$$

$$H_a: $\mu_{peaked-late} - $\mu_{peaked-early} <= 0$$
